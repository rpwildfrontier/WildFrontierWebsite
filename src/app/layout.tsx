  ...
  return (
    <html lang="fr">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,700&family=Crimson+Text:ital,wght@0,400;0,600;1,400;1,600&family=Special+Elite&family=Cinzel:wght@400;600;700;900&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
